...
def mia_to_pt_sliding_windows(plate_path:str, nlocs:int=60, len_window:int=300, 
    ...
    print("\n" + "="*40)
    print("RÉSUMÉ GLOBAL DU FILTRAGE")
    print("="*40)
    print(f"Total localisations initiales        : {total_initial}")
    print(f"Total retirées (Sigma/Intensité)     : {total_filtered_params}")
    print(f"Total retirées (Sliding Window)      : {total_filtered_window}")
    print("-" * 40)
